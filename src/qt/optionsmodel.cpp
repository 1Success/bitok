...
void OptionsModel::Init()
{
    ...
    nDisplayUnit = settings.value("nDisplayUnit", BitcoinUnits::BTK).toInt();
    ...
    fAutoRedeemBitOK = settings.value("fAutoRedeemBitOK", false).toBool();
...
QVariant OptionsModel::data(const QModelIndex & index, int role) const
{
    if(role == Qt::EditRole)
    {
        ...
        case AutoRedeemBitOK:
            return fAutoRedeemBitOK;
        case MinRingSize:
            return nMinRingSize;
        case MaxRingSize:
            return nMaxRingSize;
...
QString OptionsModel::optionIDName(int row)
{
    ...
    case AutoRedeemBitOK: return "AutoRedeemBitOK";
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DisplayAddresses:
            ...
            emit displayUnitChanged(settings.value("nDisplayUnit", BitcoinUnits::BTK).toInt());
            break;
        case DetachDatabases: {
        ...
        case AutoRingSize: {
            ...
            break;
        case AutoRedeemBitOK: {
            fAutoRedeemBitOK = value.toBool();
            settings.setValue("fAutoRedeemBitOK", fAutoRedeemBitOK);
            }
            break;
        case MinRingSize: {
...
bool OptionsModel::getAutoRedeemBitOK() { return fAutoRedeemBitOK; }
