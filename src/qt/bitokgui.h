...
/**
  BitOK GUI main class. This class represents the main window of the BitOK UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class BitOKGUI : public QMainWindow
{
    Q_OBJECT
public:
    explicit BitOKGUI(QWidget *parent = 0);
    ~BitOKGUI();
