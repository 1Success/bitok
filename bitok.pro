...
build_macosx64 {
    QMAKE_TARGET_BUNDLE_PREFIX = co.bitok
    BOOST_LIB_SUFFIX=-mt
...
contains(BITOK_NEED_QT_PLUGINS, 1) {
    DEFINES += BITOK_NEED_QT_PLUGINS
...
# also add new translations to bitok.qrc under translations/
TRANSLATIONS = $$files(src/qt/locale/bitokwallet*.ts)
...
macx:ICON = src/qt/res/icons/bitok.icns
macx:TARGET = "BitOKwallet"
